...
<head>
   ...
   <title>Dashboard | KGBP Staff</title>
...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <?php 
            $select_users = mysqli_query($conn, "SELECT * FROM `users` WHERE user_type = 'customer'") or die('query failed');
      ...
      <div class="box">
         <?php 
            $select_admins = mysqli_query($conn, "SELECT * FROM `users` WHERE user_type = 'staff'") or die('query failed');
